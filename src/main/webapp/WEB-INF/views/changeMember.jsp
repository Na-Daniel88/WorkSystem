	...
	<%-- 이부분을 반드시 숨겨서 가져가야 한다. --%>
		...
		<div class="form-row">
			<div class="form-group col-md-6">
				...
				<input type="text"	class="form-control" id="userid" name="userid" value="${vo.userid }">
			</div>
			<div class="form-group col-md-6">
		...
		<div class="form-row">
			...
			<div class="form-group col-md-6">
				...
				<input type="text" class="form-control" id="phone" name="phone" placeholder="ex. 010-0000-0000" value="${vo.phone }">
			</div>
		</div>
		<div class="form-row">
			<div class="form-group col-md-4">
				<label for="birth">생일</label> 
				<input type="text"	class="form-control" id="birth" name="birth" value="${vo.birth }">
			</div>
			<div class="form-group col-md-3">
				<label for="lvl">부서</label> 
				<select id="lvl" name="dept"	class="form-control">
		...
		<div class="form-row">
			<div class="form-group col-md-4">
				...
				<input type="text" class="form-control" id="regDate" name="regDate" value="${vo.regDate }">
			</div>
			<div class="form-group col-md-3">
		...
		<div style="text-align: center; margin: 30px;">
			<input type="submit" formaction="deleteMember" class="btn btn-danger" value="삭제">
