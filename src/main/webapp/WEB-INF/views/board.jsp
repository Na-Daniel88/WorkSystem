...
<div style="width: 900px; margin: auto; ">
	...
	<span style="font-size: 18px;">전체 : ${boardCount } 개</span>
	</div>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><fmt:formatDate value="${vo.boardDate }" pattern="yy-MM-dd HH:mm"/></td>
      <td>${vo.writer }</td>
    </tr>
...
<input type="hidden" id="searchContent" name="search_content" value="${search_content}" />
    ...
    <button type="button" class="btn btn-primary" onclick="location='boardwriteform'">글쓰기</button>
    </div>
    <div>
